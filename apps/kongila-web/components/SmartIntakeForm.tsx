  ...
  const renderStep6 = () => (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
      ...
      <div className="form-group">
        ...
        <input type="password" className="form-input" value={authData.password} onChange={e => setAuthData({...authData, password: e.target.value})} />
      </div>
      ...
      <GlassCard className="intake-card" style={{ maxWidth: '650px', width: '100%', margin: '0 auto' }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '32px' }}>
          ...
          {step < (currentUser ? 5 : 6) ? (
            ...
            <NeonButton onClick={submitRequest} disabled={isSubmitting}>
